...
embeddings = get_trimmed_w2v_vectors('data/w2v_model/biowordvec_and_kb_nlplab.npz')
print(embeddings.shape)
embeddings_2 = get_trimmed_w2v_vectors('data/w2v_model/biowordvec_nlplab.npz')
